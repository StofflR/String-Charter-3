...
const axisCheckbox = document.getElementById('axis-switch') as HTMLInputElement;

axisCheckbox.addEventListener('change', flipAxisToggle);

function flipAxisToggle() {
  const isChecked = axisCheckbox.checked;
